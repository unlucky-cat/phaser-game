...
var preloadCSV = function() {
    this.load.image('tileset', '_includes/assets/dist/img/grass_tileset_16x16.png');
    
    this.load.tilemapCSV('light', '_includes/assets/dist/apps/tiled/default_map_light.csv');
    this.load.tilemapCSV('normal', '_includes/assets/dist/apps/tiled/default_map_normal.csv');
}

var preloadJSON = function() {
    this.load.image('tileset', '_includes/assets/dist/img/grass_tileset_16x16.png');
    
    this.load.tilemapTiledJSON('map', '_includes/assets/dist/apps/tiled/default_map_embedded_tileset.json');
}
...
*/
    ...
    this.load.spritesheet('spritesheet', 
        '_includes/assets/dist/img/grass_tileset_16x16.png',
